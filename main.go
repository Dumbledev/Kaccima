...
func main() {
	...
	http.Handle("/approve_passportPhoto/{organizationId}", isAuthenticated(approvePassportPhoto))
	http.Handle("/reject_passportPhoto/{organizationId}", isAuthenticated(rejectPassportPhoto))
